...
#define qsize 10
#define ENC_PPR 325
#define ENC_IN_wheel1_A 47 //A,B pins of encoder1
#define ENC_IN_wheel1_B 51
#define ENC_IN_wheel2_A 45 //A,B pins of encoder2
#define ENC_IN_wheel2_B 43
#define ENC_IN_wheel3_A 53//A,B pins of encoder3
#define ENC_IN_wheel3_B 52
#define ENC_IN_wheel4_A 50//A,B pins of encoder4
#define ENC_IN_wheel4_B 48
...
void setup() {
  ...
  pinMode(ENC_IN_wheel1_A,INPUT_PULLUP);//Motor A
  pinMode(ENC_IN_wheel1_B,INPUT);
  attachInterrupt(digitalPinToInterrupt(ENC_IN_wheel1_A), wheel1_pulse_count_fun, RISING);
  pinMode(ENC_IN_wheel2_A,INPUT_PULLUP);//Motor B
  pinMode(ENC_IN_wheel2_B,INPUT);
  attachInterrupt(digitalPinToInterrupt(ENC_IN_wheel2_A), wheel2_pulse_count_fun, RISING);
  pinMode(ENC_IN_wheel3_A,INPUT_PULLUP);//Motor C
  pinMode(ENC_IN_wheel3_B,INPUT);
  attachInterrupt(digitalPinToInterrupt(ENC_IN_wheel3_A), wheel3_pulse_count_fun, RISING);
  pinMode(ENC_IN_wheel4_A,INPUT_PULLUP);//Motor D
  pinMode(ENC_IN_wheel4_B,INPUT);
  attachInterrupt(digitalPinToInterrupt(ENC_IN_wheel4_A), wheel4_pulse_count_fun, RISING); 
